...
import com.grupo52.tech_challenge.gateway.impl.DeleteServicoGatewayImpl;
...
public class DeleteServicoGatewayImplTest {

    @Mock
    private ServicoRepository repository;

    @InjectMocks
    private DeleteServicoGatewayImpl gateway;

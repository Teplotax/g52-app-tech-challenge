...
//                new DefaultErrorMessage(e.getMessage() + e.getCause() + e.getCause().getMessage(), HttpStatus.valueOf(e.getStatus()).toString()));
    ...
    public ResponseEntity<DefaultErrorMessage> handleValidationException(final ValidationException e) {
    ...
    public ResponseEntity<DefaultErrorMessage> handleNoResourceFoundException(final Exception e) {

        return ResponseEntity.status(NOT_FOUND).body(
                new DefaultErrorMessage("Recurso não encontrado", NOT_FOUND.toString()));
    }
